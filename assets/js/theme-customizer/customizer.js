(function ($) {
    if (localStorage.getItem("color")) $("#color").attr("href", "../Modules/assets/css/" + localStorage.getItem("color") + ".css");
    ...
    $(
        `<div class="customizer-links">
            <div class="nav flex-column nac-pills" id="c-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link" target="_blank" href="https://admin.pixelstrap.com/cuba/template/landing-page.html#" data-original-title="">
                    <div>
